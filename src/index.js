...
const products_controller_1 = __importDefault(require("./products/products.controller"));
const products_middleware_1 = __importDefault(require("./products/products.middleware"));
...
app.get('/api/v1/product/listAllProduct', products_controller_1.default.listAllProduct);
app.get('/api/v1/product/listFindProduct', products_controller_1.default.listFindProduct);
app.get('/api/v1/product/detailProduct', products_controller_1.default.detailProduct);
app.use(auth_middleware_1.default.jwtAccessToken);
app.get('/api/v1/user/profile', users_controller_1.default.profile);
app.patch('/api/v1/comments/:id', comments_middleware_1.default.checkPermission, comments_controller_1.default.update);
app.post('/api/v1/product_cart/cart', products_middleware_1.default.checkPermission, products_controller_1.default.productCart);
app.listen(port, () => {
